...
dead = c(".", "..", "", "0", "9999", "x")
data1 <- readxl::read_excel("./raw_data/AMAT_MASTERDATA_ver_14.xlsx", sheet = "growth")
...
fwrite(data1, "./clean_data/AMAT_10year_2.csv" )

```

```{r import spreadsheet data and export for SiteTools}
data1 <- fread("./clean_data/AMAT_10year_2.csv")
trees <- data1 %>% 
...
sites <- readxl::read_excel("./raw_data/AMAT_MASTERDATA_ver_14.xlsx", sheet = "sites") %>% 
...
fwrite(trial.dat, "./clean_data/AMAT_10year_best_seedlot_2.csv")
```
...
trial.dat <- fread("./clean_data/AMAT_10year_best_seedlot_2.csv")
